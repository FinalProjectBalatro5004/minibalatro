...
export default function Balatro({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      antialias: true // Better edges
    });
    const gl = renderer.gl;
    gl.clearColor(0, 0, 0, 0); // Make the clear color transparent
    ...
    gl.canvas.style.background = 'black'; // Set canvas background to black
  ...
  return (
    <div 
      ...
      style={{ 
        ...
        left: 0,
        zIndex: 0,
        background: 'black' // Add a black background to the container
      }} 
    />
  );
} 